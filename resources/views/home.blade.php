...
<head>
    ...
    <link rel="manifest" href="{{ asset('homePage_assets/favicon/site.webmanifest') }}">
    <link rel="mask-icon" href="{{ asset('homePage_assets/favicon/safari-pinned-tab.svg') }}" color="#5bbad5">
...
<body>
    ...
    <header class="header" id="header">
        <nav class="nav container">
            <a href="" class="nav-logo">
                <img src="{{ asset('homePage_assets/img/logo.png') }}" alt="" class=""> Farmers Marketplace
            </a>
            <span style="">
    ...
    <main class="main">
        <section class="home section" id="home">
            <div class="home-container container grid">
                <div class="home-data">
                    ...
                    <!-- <img src="img/apple.png" alt="" class="home-fruit"> -->
                </div>

                <img src="{{ asset('homePage_assets/img/hero.jpg') }}" alt="" class="home-img">
            </div>
        </section>
        ...
        <section class="section-alt">
            <div class="about-container container grid">
                <img src="{{ asset('homePage_assets/img/basket.png') }}" alt="" class="about-img">
        ...
        <section class="section-alt">
            <div class="about-container container grid">
                ...
                <img src="img/basket.png" alt="" class="about-img">
            </div>
        </section>
        ...
        <section class="popular section" id="about">
            ...
            <p class="section-description">
                At Farmers Marketplace, we bring the farm to your table. Our marketplace offers an extensive selection of farm produce, including:
            </p>
            ...
            <div class="popular-container container grid">
                <article class="popular-card">
                    ...
                    <img src="{{ asset('homePage_assets/img/apple.png') }}" alt="" class="popular-img">
                    <h3 class="popular-title">Fresh Fruits</h3>
                    <span class="popular-subtitle">Enjoy the juiciest apples, berries, citrus fruits, and more, straight from the orchard</span>
                </article>
                <article class="popular-card">
                    <div class="popular-bg"></div>

                    <img src="{{ asset('homePage_assets/img/vegetable.png') }}" alt="" class="popular-img">
                    <h3 class="popular-title">Crisp Vegetables</h3>
                    <span class="popular-subtitle">From leafy greens and vibrant peppers to root vegetables and exotic varieties, our marketplace has it all</span>
                </article>
                <article class="popular-card">
                    <div class="popular-bg"></div>

                    <img src="{{ asset('homePage_assets/img/cow.png') }}" alt="" class="popular-img">
                    <h3 class="popular-title">Farm-Raised Meats</h3>
                    <span class="popular-subtitle">Savor the flavor of locally sourced beef, pork, poultry, and seafood</span>
                </article>
                <article class="popular-card">
                    <div class="popular-bg"></div>

                    <img src="{{ asset('homePage_assets/img/milk.png') }}" alt="" class="popular-img">
                    <h3 class="popular-title">Dairy Delights</h3>
                    <span class="popular-subtitle">Indulge in creamy cheeses, farm-fresh milk, and artisanal butter</span>
                </article>
                <article class="popular-card">
                    <div class="popular-bg"></div>

                    <img src="{{ asset('homePage_assets/img/organic.png') }}" alt="" class="popular-img">
                    <h3 class="popular-title">Organic Options</h3>
                    <span class="popular-subtitle">Discover a range of certified organic produce, free from pesticides and chemicals</span>
                </article>
            </div>
        </section>
        ...
        <section class="popular section" id="why">
            ...
            <div class="popular-container-alt container grid">
                <article class="popular-card-alt">
                    ...
                    <img src="{{ asset('homePage_assets/img/1.png') }}" alt="" class="popular-img-alt">
                ...
                <article class="popular-card-alt">
                    ...
                    <img src="{{ asset('homePage_assets/img/2.png') }}" alt="" class="popular-img-alt">
                ...
                <article class="popular-card-alt">
                    ...
                    <img src="{{ asset('homePage_assets/img/3.png') }}" alt="" class="popular-img-alt">
                ...
                <article class="popular-card-alt">
                    ...
                    <img src="{{ asset('homePage_assets/img/4.png') }}" alt="" class="popular-img-alt">
        ...
        <section class="how section" id="how">
            ...
            <div class="how-container container grid">
                <article class="how-card">
                    ...
                    <img src="{{ asset('homePage_assets/img/market.png') }}" alt="" class="how-img">
                </article>
                ...
                <article class="how-card">
                    ...
                    <img src="{{ asset('homePage_assets/img/buy.png') }}" alt="" class="how-img">
                </article>
                ...
                <article class="how-card">
                    ...
                    <img src="{{ asset('homePage_assets/img/fast-delivery.png') }}" alt="" class="how-img">
                </article>
                ...
                <article class="how-card">
                    ...
                    <img src="{{ asset('homePage_assets/img/apple.png') }}" alt="" class="how-img">
                </article>
            </div>
        </section>
                ...
                <div class="join-content grid">
                    <div class="join-data">
                        ...
                        <p class="join-description">
                            Access fresh, ethically sourced food from the comfort of your home.
                            We're currently available on Google Playstore
                        </p>

                        <a target="_blank" href="https://play.google.com/store/apps/details?id=com.reotech.farmers_marketplace"><img src="{{ asset('homePage_assets/img/google.png') }}" alt="" class="google"></a>

                    </div>
                    <img src="{{ asset('homePage_assets/img/hero.jpg') }}" alt="" class="join-bg">
                </div>
            </div>
        </section>
    </main>
    ...
    <footer class="footer" id="contact">
        <div class="footer-container container grid">
            <div>
                <a href="" class="footer-logo">
                    <img src="{{ asset('homePage_assets/img/logo-alt.png') }} " alt="">Farmers Marketplace
                </a>
            ...
            <div class="footer-data grid">
                ...
                <div>
                    ...
                    <ul class="footer-links">
                        <li><a href="" class="footer-link">+234 902 813 5986</a></li>
                        <li><a href="mailto:hello@farmersmarketplace.ng" class="footer-link">hello@farmersmarketplace.ng</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div class="footer-social">
                        <a href="http://facebook.com/farmersmarketplaceng" target="_blank" class="footer-social-link">
                            <i class="ri-facebook-circle-line"></i>
                        </a>
                        <a href="http://instagram.com/farmersmarketplace.ng" target="_blank" class="footer-social-link">
        ...
        <div class="tooltip">
            ...
            <i class="tooltip-tooltip">Images by Freepik, Icons from Flaticon</i>
        </div>
    </footer>
    ...
    <!--=============== SCROLLREVEAL ===============-->
    <script src="{{ asset('homePage_assets/js/scrollreveal.min.js') }}"></script>
